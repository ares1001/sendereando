    ...
    <View style={styles.container}>
      ...
      <View style={styles.contentContainer}>
        <View style={styles.containerText}>
          <Text style={styles.SuccessText}>Verifica tu email para que puedas empezar a disfrutar de los mejores senderos de Argentina </Text>
         
        </View>
      
        <TouchableOpacity style={styles.button} onPress={() => navigation.push("Populares")}>
